...
require (
	...
	github.com/tikv/client-go/v2 v2.0.8-0.20230908081520-dbe9bcf80389
...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/bufferflies/client-go/v2 v2.0.0-20230908100041-c8faf8fcb543
)
